...
public class DateUtils {
    ...
    public static final String DF_YYYYMMDD_HHMMSS = "yyyyMMdd HHmmss";
    ...
    public static void main(String[] ages) throws ParseException {
        Date date1 = DateUtils.parse("2019-01-02 12:20:20","yyyy-MM-dd HH:mm:ss");
        Date date2 = DateUtils.parse("2019-01-03 12:20:20","yyyy-MM-dd HH:mm:ss");

        DateTime jdate = new DateTime(date1);
        DateTime jdate2 = new DateTime(date2);

        System.out.println(jdate2.isAfter(jdate2));
    }
}
