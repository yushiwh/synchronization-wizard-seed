 ...
 * FileName: TtlProductInfoServiceImpl
 * Author:   nick
...
import com.jzt.sync.constant.ExcelFormat;
import com.jzt.sync.core.AbstractService;
import com.jzt.sync.dao.TtlProductInfoMapper;
import com.jzt.sync.model.ExcelHeaderInfo;
import com.jzt.sync.model.TtlProductInfoPo;
import com.jzt.sync.service.TtlProductInfoService;
import com.jzt.sync.util.ExcelUtils;
...
@Service
@Slf4j
public class TtlProductInfoServiceImpl extends AbstractService<TtlProductInfoPo> implements TtlProductInfoService {
    ...
    public List<TtlProductInfoPo> listProduct(Map<String, Object> map) {
        ...
        PageHelper.startPage(Integer.parseInt(map.get("offset").toString()),
                Integer.parseInt(map.get("limit").toString()));
        PageInfo<TtlProductInfoPo> pageInfo = new PageInfo(this.mapper.selectAll());
    ...
    private Map<String, ExcelFormat> getFormatInfo() {
        Map<String, ExcelFormat> format = new HashMap<>(6);
